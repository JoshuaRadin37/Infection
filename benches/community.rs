...
use infection::game::pathogen::symptoms::base::cheat::{CustomCatchChance, CustomInternalSpreadRate};
...
fn infected_population_update(c: &mut Criterion) {
    ...
    for size in &[10, 100, 1000, 10000] {
        ...
        group.bench_with_input(
            ...
            size,
            |b, &size| {
                let mut pop = Population::new(&PersonBuilder::new(), 0.0, size, UniformDistribution::new(0, 120));
