...
mod community {
    ...
    use infection::game::pathogen::symptoms::base::cheat::{CustomCatchChance, CustomDuration, CustomFatality, CustomSeverity, CustomSpread};
    ...
    fn run_pop(mut pop: Population, pathogen: &Arc<Pathogen>) {
        ...
        let pop = pop_arc.lock().unwrap();
        println!("Death Count = {}", pop.get_original_population() - pop.get_total_population());
        println!("% Infected = {}%", (pop.get_all_ever_infected() + pop.get_original_population() - pop.get_total_population()) as f64 / pop.get_original_population() as f64 * 100.0);
        println!("Mortality Rate = {}%", (pop.get_original_population() - pop.get_total_population()) as f64 / ( pop.get_all_ever_infected() +pop.get_original_population() - pop.get_total_population())  as f64 * 100.0);
        println!("Took {} loops to complete", loops);
    }
}